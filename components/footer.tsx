			...
			<div className="bg-footer dark:bg-offgray-950">
				<div className="container mx-auto py-10 px-4 grid grid-cols-1 md:grid-cols-3">
					...
					<div className="w-full flex flex-col gap-4 items-start justify-center mb-6">
						<h5 className="font-lora h5 scroll-mt-24 font-medium text-pretty">
							İletişime Geçin
						</h5>
						<a href="tel:+902124654327" className="text-center text-xs">
							+90 212 212 12 12
						</a>
					</div>
					<div className="w-full flex flex-col gap-4 items-start justify-center mb-6">
						...
						<p className="text-start text-xs leading-relaxed">
